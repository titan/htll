...
(define (usage prog)
  ...
  (newline)
  (display "cell-declaration\t\t")
  (display "generate variable declarations for the table cell")
  (newline))
                    ...
                    (let src-loop ((srcs (read-file file)))
                      (if (null? srcs)
                          (cond
                           ...
                           ((eq? action 'cell-declaration) (generate-cell-declaration the-global-environment))
                           ((eq? action 'eval) 'ok)
